...
MSG * /TIME:3 執行00-offduty_schedule.bat
...
::::::::::::::::::::::::::::
echo. > %M0_LOG%    
echo. :::  "3-1825-下班後重開機 run D:\Msg\Use\00-offduty_schedule.bat"  			>> %M0_LOG%                                                         
echo. :::  ============================================================= 			>> %M0_LOG%
echo. :::  ============================================================= 			>> %M0_LOG%  
echo. :::  -----------     every thing  off-----------3,4,5 on	-----------			>> %M0_LOG% 
REM ::schtasks /CHANGE /DISABLE /TN "\0830_班\0900-START_HYVideoDesktop"					>> %M0_LOG% 
schtasks /CHANGE /DISABLE /TN "\0830_班\0825-記得簽到"								>> %M0_LOG%    
schtasks /CHANGE /DISABLE /TN "\0830_班\1-0750-上班前重開機"						>> %M0_LOG% 
schtasks /CHANGE /DISABLE /TN "\0830_班\1630-W-每周35_檢查備份硬碟已備妥至抽取盒"	>> %M0_LOG%
schtasks /CHANGE /DISABLE /TN "\0830_班\1730-記得簽退"								>> %M0_LOG%  
...
schtasks /query /fo csv /nh /TN "\0830_班\1630-W-每周35_檢查備份硬碟已備妥至抽取盒"	>> %M0_LOG%
schtasks /query /fo csv /nh /TN "\0830_班\1730-記得簽退"							>> %M0_LOG%  
...
:L0_EXIT_OUT
::msg_str_sec_bye.eee '完成00-offduty_schedule.bat' 3 
MSG * /TIME:3 完成00-offduty_schedule.bat
@echo off
SET M0_WEP=
set M0_event=
SET M0_RUNDIR=
...
:L1_CK_FILE_ERR01
	...
	echo  *** 找不到   %M0_RUNDIR%\msg_str_sec_bye.eee  >> %M0_LOG%	
	echo  *** 找不到   %M0_RUNDIR%\msg_str_sec_bye.eee  >> %M0_LOG%
	echo  *** 找不到   %M0_RUNDIR%\msg_str_sec_bye.eee 
	echo  *** 找不到   %M0_RUNDIR%\msg_str_sec_bye.eee  
	echo  *** 找不到   %M0_RUNDIR%\msg_str_sec_bye.eee  
	timeout /t 300
