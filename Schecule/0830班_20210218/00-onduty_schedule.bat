...
schtasks /CHANGE /ENABLE  /TN "\0830_班\1630-W-每周35_檢查備份硬碟已備妥至抽取盒"	>> %M0_LOG%
schtasks /CHANGE /ENABLE  /TN "\0830_班\1730-記得簽退"								>> %M0_LOG%  
...
::SENDMAG
::::::::::::::::::::::::::::
SET M0_MSG_CHT_STR="%date%"-"%time%"_1825-下班後重開機,執行排程00-onduty_schedule_OK[平日排上班程啟用成功][其他 ON - 3,4,5,OFF]
