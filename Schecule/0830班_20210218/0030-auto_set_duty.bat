...
REM ::schtasks /CHANGE /DISABLE /TN "\0830_班\0900-START_HYVideoDesktop"				>> %M1_LOG_WORK%
schtasks /CHANGE /ENABLE  /TN "\0830_班\0825-記得簽到"								>> %M1_LOG_WORK%    
schtasks /CHANGE /ENABLE  /TN "\0830_班\1-0750-上班前重開機"						>> %M1_LOG_WORK% 
schtasks /CHANGE /ENABLE  /TN "\0830_班\1630-W-每周35_檢查備份硬碟已備妥至抽取盒"	>> %M1_LOG_WORK%
schtasks /CHANGE /ENABLE  /TN "\0830_班\1730-記得簽退"								>> %M1_LOG_WORK%  
...
schtasks /query /fo csv /nh /TN "\0830_班\1630-W-每周35_檢查備份硬碟已備妥至抽取盒"	>> %M1_LOG%
schtasks /query /fo csv /nh /TN "\0830_班\1730-記得簽退"							>> %M1_LOG%  
...
schtasks /CHANGE /DISABLE /TN "\0830_班\0825-記得簽到"								>> %M1_LOG_WORK%
schtasks /CHANGE /DISABLE /TN "\0830_班\1-0750-上班前重開機"						>> %%M1_LOG_WORK%
schtasks /CHANGE /DISABLE /TN "\0830_班\1630-W-每周35_檢查備份硬碟已備妥至抽取盒"	>> %M1_LOG_WORK%
schtasks /CHANGE /DISABLE /TN "\0830_班\1730-記得簽退"								>> %M1_LOG_WORK%  
schtasks /CHANGE /DISABLE /TN "\0830_班\2-0800-1829-上班期間系統開機後"				>> %M1_LOG_WORK% 
echo. ::: "0830_班\3-1825-下班後重開機 永遠 ON "									>> %M1_LOG_WORK% 
echo. :::  ----------- 3 Always ON---------------------------------					>> %M1_LOG_WORK%  
schtasks /CHANGE /ENABLE  /TN "\0830_班\3-1825-下班後重開機"						>> %M1_LOG_WORK% 
