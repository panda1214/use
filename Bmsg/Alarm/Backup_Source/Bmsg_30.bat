...
@echo off
REM *******************************************
REM	Main Func BM_30.bat 顯示大型訊息 30秒
REM **********************************************
...
D:
CD "D:\MSG\USE"
:::REM START nircmd.exe mutesysvolume 0
:::REM START nircmd.exe setsysvolume 65535 

C:
CD "C:\Program Files\Microsoft Office\Office16"
:::REM START /min OUTLOOK.EXE

C:
CD "C:\Program Files\Microsoft Office\Office15\"
:::REM START /min lync.exe



C:
cd "C:\Program Files (x86)\Rainlndar"
:::REM START /min Rainlendar2.exe

C:
CD "C:\Program Files\Rainmeter\"
:::REM START /min Rainmeter.exe

REM ::: 軟體每隔一段時間模擬鍵盤操作，進而避免關機 :::
D:
CD "D:\Win10_64_APP\caffeine(軟體每隔一段時間模擬鍵盤操作，進而避免關機)\"
:::REM START /min caffeine64.exe 
