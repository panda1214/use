...
set M0_LOG=%M0_RUNDIR%\LOG\F_Shutdown_bat.log
...
SET M0_MSG_CHT_STR="%date%"-"%time%"___執行排程____F_Shutdown.bat____成功
...
CD %M0_RUNDIR%
echo. > %M0_LOG%
::msg_str_sec_bye.eee '執行排程_F_Shutdown.bat' 5
MSG * /TIME:3 "                         執行排程關機-F_Shutdown.bat       "
echo. *****************************************************	>> %M0_LOG%
echo. 程式執行名稱 F_Shutdown.bat								>> %M0_LOG%
...
:L0_EXIT_OUT
msg_str_sec_bye.eee '完成排程F_Shutdown.bat成功' 5 
set M0_RUNDIR=
set M0_LOG=
SET M0_WEP=
set M0_event=
...
SET M0_LOG=
SET M0_MSG_CHT_STR=
::msg_str_sec_bye.eee '排程關機' 5 
MSG * /TIME:5 "                         完成排程關機       "
shutdown /s /t 30 /f /c "AUTO_POWER_OFF"
