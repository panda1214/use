...
CD  %M0_RUNDIR%           
echo. > %M0_LOG%   
msg_str_sec_bye.exe 執行0-1900_Schedule_Enable.bat 5

echo. :::  Run D:\Msg\Use\0-1900_Schedule_Enable.bat                          
echo. :::  ============================================================= 			>> %M0_LOG%  
echo. :::  -----------     every thing  on ----------  4 5 off	-----------			>> %M0_LOG%    
schtasks /CHANGE /ENABLE  /TN "\0830_班\0825-記得簽到"								>> %M0_LOG%    
schtasks /CHANGE /ENABLE  /TN "\0830_班\0900-START_HYVideoDesktop"					>> %M0_LOG% 
schtasks /CHANGE /ENABLE  /TN "\0830_班\1-0750-上班前重開機"						>> %M0_LOG% 
schtasks /CHANGE /ENABLE  /TN "\0830_班\1630-W-每周五_檢查備份硬碟已備妥至抽取盒"	>> %M0_LOG%
schtasks /CHANGE /ENABLE  /TN "\0830_班\1728-1730_D-金控人資簽退"					>> %M0_LOG%  
