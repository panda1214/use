::::::::::::::::::::::::::::
REM 0-0100_Schedule_Disable
REM 休假當日早上0100設定為休假日, 執行本程式將程設為休假中
REM 1,2 Others Off 			, 3,4,5 On
REM  停用 國安-電券早班 排程    
...
SET M0_LOG=\Msg\Use\Log\0-0100_Schedule_Disable.txt  
D:
CD  %M0_RUNDIR%
 
msg_str_sec_bye.exe 執行0-0100_Schedule_Disable.bat 5  
echo. > %M0_LOG%                                
echo. :::  0-0100_Schedule_Disable											>> %M0_LOG% 
echo. :::  休假當日早上0100設定為休假日, 執行本程式將程設為休假中			>> %M0_LOG% 
echo. :::  1,2 Others Off 			, 3,4,5 On								>> %M0_LOG% 
echo. :::  ===========1,2 OFF========================================= 		>> %M0_LOG% 
schtasks /CHANGE /DISABLE /TN "\0830_班\1-0750-上班前重開機"				>> %M0_LOG% 
schtasks /CHANGE /DISABLE /TN "\0830_班\2-0800-1829-上班期間系統開機後"		>> %M0_LOG% 

echo. :::  ============Others Off================================================= 	>> %M0_LOG% 
...
:L0_EXIT_OUT
msg_str_sec_bye.exe 完成0-0100_Schedule_Disable.bat 5 
SET M0_WEP=
set M0_event=
SET M0_RUNDIR=
SET M0_LOG=
