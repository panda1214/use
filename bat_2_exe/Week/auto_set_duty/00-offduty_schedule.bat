...
msg_str_sec_bye.exe 執行00-offduty_schedule.bat 5  
echo. > %M0_LOG%    
...
SET M0_MSG_CHT_STR="%date%"-"%time%"_1900-執行排程00-offduty_schedule**[下班排程_3,4,5,ON]**成功
...
:L0_EXIT_OUT
msg_str_sec_bye.exe 完成00-offduty_schedule.bat 5
SET M0_WEP=
set M0_event=
SET M0_RUNDIR=
SET M0_LOG=
