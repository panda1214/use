...
@echo off
:L0_MAIN_START01
SET M1_H1="詢問是否打開_FreeAlarmClock_訊息提醒視窗"
:: M1_H1=MagBox TITLE

SET M1_L1="工作提醒" +vbCrLf+vbCrLf
SET M1_L2="***本程式如未選擇: 表示無人值守 1800 秒後自動結束程式***" +vbCrLf+vbCrLf
SET M1_L3="(1)按下[是]_請打開_FreeAlarmClock_" +vbCrLf+vbCrLf
...
:L0_YES
	call "C:\Program Files (x86)\FreeAlarmClock\FreeAlarmClock.exe"
	D:\Msg\Use\EXE\msg_str_sec_bye.exe FreeAlarmClock已打開 30
	goto L0_EXIT
